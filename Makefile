...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 18. ??? 12:34:59 2019
# Project:  AztecCoin-Qt.pro
# Template: app
# Command: c:/qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile AztecCoin-Qt.pro
#############################################################################
...
Makefile: AztecCoin-Qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/azt/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/azt/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/azt/src/leveldb/libleveldb.a: FORCE
	cd C:/azt/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -O2" libleveldb.a libmemenv.a && ranlib C:/azt/src/leveldb/libleveldb.a && ranlib C:/azt/src/leveldb/libmemenv.a
